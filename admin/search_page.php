...
<section class="posts">
   ...
   <h1 class="heading">advertisments</h1>
   ...
   <div class="box-container">
      ...
      if(isset($_POST['search']) or isset($_POST['search_btn'])){
         $search = $_POST['search'];
         $select_post = $conn->prepare("SELECT * FROM `post` WHERE title LIKE '%{$search}%' AND admin_id = ? ORDER BY date DESC");
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete_post" class="delete-btn" onclick="return confirm('delete this post?');" name="delete">
         </form>
