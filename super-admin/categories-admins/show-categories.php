        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
             ...
             <a  href="create-categoryphp" class="btn btn-primary mb-4 text-center float-right">Create Categories</a>
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                ...
                <tbody>
                  <tr>
                    <th scope="row">1</th>
                    <td>Mark</td>
                    <td><a  href="update-categoryphp" class="btn btn-warning text-white text-center ">Update Categories</a></td>
                    <td><a href="delete-categoryphp" class="btn btn-danger  text-center ">Delete Categories</a></td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
                    <td>Jacob</td>
